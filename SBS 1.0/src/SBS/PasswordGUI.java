...
public class PasswordGUI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        labelPass.setIcon(new javax.swing.ImageIcon(getClass().getResource("/SBS/Icons/password-icon-40x40.png"))); // NOI18N
    ...
    private void labelPassOnOfflabelDeviceOnOffMainEvent(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_labelPassOnOfflabelDeviceOnOffMainEvent
        boolean passOn= setting.getBoolValue("sbsPassActive");
        String getPass= setting.getStingValue("sbsPass");
        if(passOn){
            enterPass.setVisible(true);
            if(setting.getBoolValue("sbsPassCorrect")){
                setting.SaveSetting("bool", "sbsPassActive", "false");
                setting.SaveSetting("string", "sbsPass", "");
            }
        }
        else{
            if(getPass!=null && getPass.length()>2){
                setting.SaveSetting("bool", "sbsPassActive", "true");
            }
            else{
                JLabel msgLabel= new JLabel();
                msgLabel.setFont(new Font ("Microsoft tai le", Font.BOLD, 16));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(getInfo()){
            if(setting.getBoolValue("sbsPassActive")){
                enterPass.setVisible(true);
                if(setting.getBoolValue("sbsPassCorrect")){
                    setting.SaveSetting("string", "sbsPass", pass);
                    setting.SaveSetting("bool", "sbsPassActive", "true");
                    JLabel msgLabel= new JLabel();
                    msgLabel.setFont(new Font ("Microsoft tai le", Font.BOLD, 16));
